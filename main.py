...
def main():
    ...
    while True:
        ...
        # 8 for ipv4
        if eth_proto == 8:
            (version, header_length, ttl, protocol, src, target, data) = ipv4(data)
            ...
            if protocol == 1:
                ...
                print(TAB_2 + 'Data: ')
                print(format_mutlilines(DATA_TAB_3, data))
            # TCP
            elif protocol == 6:
                src_port, dest_port, sequence, acknowledgement, flag_urg, flag_ack, flag_psh, flag_rst, flag_syn, flag_fin, data = tcp_segment(
                    data)
            ...
            # other
                ...
                print(TAB_1 + 'Data: ')
                print(format_mutlilines(DATA_TAB_2, data))
...
# format data
def format_mutlilines(prefix, string, size=80):
    size -= len(prefix)
